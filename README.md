...
- `data/projects.js` — single source of truth for project metadata (title, date, tags, thumbnail, link)
...
1. Add a new entry to the `PROJECTS` array in [`data/projects.js`](data/projects.js).
